...
namespace UBA\DHLExpress\Controller\Adminhtml\System;
...
class ExportRates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    ...
    {
        /** @var $gridBlock \UBA\DHLExpress\Block\Adminhtml\VariableRate\ExportGrid */
        $gridBlock = $this->_view->getLayout()->createBlock(
            \UBA\DHLExpress\Block\Adminhtml\VariableRate\ExportGrid::class
        );

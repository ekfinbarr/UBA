...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), "1.0.1", "<")) {
            $configs = [
                'carriers/dhlexpress/label/default_extra_insurance' => 'carriers/dhlexpress/label/default_extra_assured'
            ];
        ...
        if (version_compare($context->getVersion(), "1.0.2", "<")) {
            $configs = [
                'carriers/dhlexpress/usability/bulk/print' => 'carriers/dhlexpress/usability/bulk/download'
            ];
            $this->updateConfigPaths($configs);
        ...
        if (version_compare($context->getVersion(), "1.0.15", "<")) {
            $configs = [
                'carriers/dhlexpress/usability/auto_print/enabled'         => 'carriers/dhlexpress/usability/automation/shipment',
                'carriers/dhlexpress/usability/auto_print/on_order_status' => 'carriers/dhlexpress/usability/automation/on_order_status',
                'carriers/dhlexpress/usability/auto_print/auto_print'      => 'carriers/dhlexpress/usability/automation/print'
            ];
            $this->updateConfigPaths($configs);
        }
    ...
    private function addProductBlacklistAttributes()
    {
        ...
        $this->eavSetup->addAttribute(
            ...
            [
                ...
                'input'                   => 'multiselect',
                'class'                   => '',
                'source'                  => \UBA\DHLExpress\Model\Entity\Attribute\Source\Blacklist::class,
                'global'                  => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
                'visible'                 => true,
                'required'                => false,
                'user_defined'            => false,
    ...
    private function updateProductBlacklistServicePointAttributeSourceModel()
    {
        $this->eavSetup->updateAttribute(
            ...
            Carrier::BLACKLIST_SERVICEPOINT,
            'source_model',
            \UBA\DHLExpress\Model\Entity\Attribute\Source\NoYes::class
        );
    }
    ...
    private function updateBlacklistSourceClass()
    {
        $this->eavSetup->updateAttribute(
            ...
            Carrier::BLACKLIST_GENERAL,
            'source_model',
            \UBA\DHLExpress\Model\Entity\Attribute\Source\Blacklist::class
        );
    }
    ...
    private function addBlacklistAll()
    {
        ...
        $this->eavSetup->addAttribute(
            ...
            [
                ...
                'input'                   => 'select',
                'class'                   => '',
                'source'                  => \UBA\DHLExpress\Model\Entity\Attribute\Source\NoYes::class,
                'global'                  => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
                'visible'                 => true,
                'required'                => false,
                'user_defined'            => false,

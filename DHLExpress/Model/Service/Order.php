...
use UBA\DHLExpress\Model\Exception\NotShippableException;
use UBA\DHLExpress\Model\Exception\FaultyServiceOptionException;
...
class Order
{
    ...
    public function createShipment($orderId)
    {
        ...
        try {
            $shipment->setData('uba_dhlexpress_is_created', true);
            $this->shipmentResource->saveAttribute($shipment, ['uba_dhlexpress_is_created']);
            $shipment->register();
